...
const MembersProfile = ({name, role, image}) => {
  return (
                 <div className='bg-white shadow-md rounded-lg p-4 border border-gray-200 hover:-translate-y-2 transition-all duration-200 ease-in-out hover:ring-2 ring-green-600 cursor-pointer'>
